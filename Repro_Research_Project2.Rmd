...
The working environment is cleared and required packages are loaded. Then data is laoded directly from the zip file. To save space in memory only the varaibles needed for the analysis are loaded.
...
specific format. For instance, there are events with many variations in naming conventions. Intial Inspection shows alot of work is needed to correct this. However, as this assigment is about reproducible research and not data analysis, only a minimum will be done to transfrom the data
...
==================================
Top 10 events that caused largest greatest Economic Loss
